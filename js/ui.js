        ...
        <div class="bg-[#191919] rounded-lg p-6 max-w-md w-full max-h-[90vh] overflow-y-auto relative">
            ...
            <div class="mb-0">
                ...
                <div class="flex justify-end space-x-2">
                    ...
                    <button id="cancelBoxModal" class="ml-2 bg-yellow-600 hover:bg-yellow-700 text-white px-4 py-1 rounded">取消</button>
                </div>
            </div>
        </div>`;
                ...
                <div id="dropZone" class="w-full py-9 bg-[#111] rounded-2xl border border-gray-300 gap-3 grid border-dashed">
                    ...
                    <div class="flex items-center justify-center gap-2">
                        <label>
                            ...
                            <div class="flex w-28 h-9 px-2 flex-col bg-yellow-600 rounded-full shadow text-white text-xs font-semibold leading-4 items-center justify-center cursor-pointer focus:outline-none">选择文件</div>
                        </label>
